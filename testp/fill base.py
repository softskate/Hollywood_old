...
##        curs2.execute("INSERT OR IGNORE INTO hollywood_movie_writers (movie_id,writer_id) VALUES (?,?)", (i[0],i[3]))
##        con2.commit()
##    else:
##        for x in eval(i[8]):
##            print(x)
##            curs2.execute("INSERT OR IGNORE INTO hollywood_movie_writers (movie_id,writer_id) VALUES (?,?)", (i[0],x['id']))
##            con2.commit()
...
##    for x in actors_ids:
##        curs2.execute("INSERT OR IGNORE INTO hollywood_movie_actors (movie_id,actor_id) VALUES (?,?)", (i[0],x[0]))
##        con2.commit()
